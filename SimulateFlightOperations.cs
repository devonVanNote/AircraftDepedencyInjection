...
{
    public class SimulateFlightOperations
    {
        static void Main(string[] arguments)
        {
            IAircraft F16 = new Jet(Airports.StLouis, DateTime.Now.AddHours(3), Airports.Chicago, DateTime.Now.AddHours(2).AddMinutes(15), Guid.NewGuid(), Aircraft.Jet);
